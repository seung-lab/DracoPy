...
RUN /opt/python/cp38-cp38/bin/pip3.9 install pip --upgrade
...
RUN /opt/python/cp38-cp38/bin/pip3.9 install scikit-build twine
...
RUN /opt/python/cp38-cp38/bin/python3.9 setup.py develop
...
RUN /opt/python/cp38-cp38/bin/python3.9 -m pytest -v -x tests.py
...
RUN /opt/python/cp38-cp38/bin/python3.9 setup.py sdist bdist_wheel
