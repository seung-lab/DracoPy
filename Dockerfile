...
RUN /opt/python/cp311-cp311/bin/pip3.10 install pip --upgrade
...
RUN /opt/python/cp311-cp311/bin/pip3.10 install scikit-build twine oldest-supported-numpy
...
RUN /opt/python/cp311-cp311/bin/python3.10 setup.py develop
...
RUN /opt/python/cp311-cp311/bin/python3.10 -m pytest -v -x tests.py
...
RUN /opt/python/cp311-cp311/bin/python3.10 setup.py sdist bdist_wheel
